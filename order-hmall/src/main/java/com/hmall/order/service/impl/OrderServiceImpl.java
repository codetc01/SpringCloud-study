...
import com.hmall.api.client.cartClients;
...
//    private final ICartService cartService;
    ...
    private final cartClients cartClients;
    ...
    public Long createOrder(OrderFormDTO orderFormDTO) {
        ...
        // 1.1.查询商品
        List<com.hmall.api.dto.OrderDetailDTO> detailDTOS = orderFormDTO.getDetails();
        // 1.2.获取商品id和数量的Map
...
//        cartService.removeByItemIds(itemIds);
        cartClients.deleteByIds(itemIds);

        // 4.扣减库存
        try {

            itemClients.deductStock(detailDTOS);
